    ...
    <div>
      ...
      <main>
        ...
        <div className="row about-container">
          ...
          <div className="col-sm-6 order-sm-2 d-flex justify-content-center align-items-center about-image">
            <img
              src={AboutImage}
              alt=""
        ...
        <div className="soft-skills-container">
          ...
          <p className="body-text-medium">
            ...
            feedback effectively with team members, ensuring clear understanding
            and coordination on tasks and objectives.
          </p>
          <h4 id="heading-text">Collaboration and Teamwork</h4>
          <p className="body-text-medium">
            I have gained valuable experience collaborating on coding projects,
            where I improved my ability to work as part of a team and utilise
            various tools to communicate effectively and efficientl with team
            members.
          </p>
          <h4 id="heading-text">Adaptability and Problem-Solving</h4>
          <p className="body-text-medium">
            I'm quick to learn and adapt to tools or technologies used by the
            team. Debugging code and addressing usability issues are some of the
            problem-solving skills I’ve improved.
          </p>
        </div>
